...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoint_path_af', default=None, type=str, help='Path to pSp model checkpoint')
		...
		# self.parser.add_argument('--edit_type', edit_paths)
		...
		self.parser.add_argument('--edit_attribute', default=None, type=str, help='smile, age, eyes, bread, lip, pose')
		self.parser.add_argument('--edit_degree', default=3.0, type=float)
		...
		self.parser.add_argument('--is_car', action='store_true')
